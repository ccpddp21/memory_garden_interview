/*
Derived from Three.js Godrays example: https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_godrays.html
*/
...
function init() {
    ...
    loader.load('models/interview_test_1.glb', function (object) {
        console.log(typeof(object.scene.scale.multiplyScalar(4)));
